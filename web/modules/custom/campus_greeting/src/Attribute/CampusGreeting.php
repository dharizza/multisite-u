...
namespace Drupal\campus_greeting\Attribute;

use Drupal\Component\Plugin\Attribute\Plugin;
use Drupal\Core\StringTranslation\TranslatableMarkup;

/**
 * The campus_greeting attribute.
 */
#[\Attribute(\Attribute::TARGET_CLASS)]
final class CampusGreeting extends Plugin {

  /**
   * Constructs a new CampusGreeting instance.
   *
   * @param string $id
